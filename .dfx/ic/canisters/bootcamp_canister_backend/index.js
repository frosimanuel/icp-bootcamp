...
import { idlFactory } from './bootcamp_canister_backend.did.js';
export { idlFactory } from './bootcamp_canister_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BOOTCAMP_CANISTER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bootcamp_canister_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bootcamp_canister_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bootcamp_canister_backend.did.js")._SERVICE>}
 */
export const bootcamp_canister_backend = createActor(canisterId);
